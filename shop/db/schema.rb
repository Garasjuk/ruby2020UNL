...
ActiveRecord::Schema.define(version: 2020_06_22_214636) do
  ...
  create_table "product_orders", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "quantity"
